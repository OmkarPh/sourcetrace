...
import { NEW_COMER, ONBOARDING_ROUTE } from "../../constants/routes";
import { NavbarContainer, AppName, Login, Signup } from "./navbar.styled";
import LinkIcon from '@mui/icons-material/Link';
import Image from "next/image";

const Navbar = () => {
  const router = useRouter();
  const { connect, metaState, isLoggedIn, isProcessingLogin, profile } =
    useMetamaskAuth();
  console.log({
    metaState,
    isLoggedIn,
